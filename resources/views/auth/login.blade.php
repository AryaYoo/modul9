...
@extends('layouts.defaults_login')
    ...
    <div class="row justify-content-center">
        <div class="p-5 bg-light rounded-3 col-xl-4 border">
                ...
                <div class="mb-3 text-center">
                    {{-- <i class="bi-hexagon-fill me-2"> --}}
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="blue" class="bi bi-hexagon-fill" viewBox="0 0 16 16">
                ...
                <div class="row">
                    <div class="col-md-12 d-grid">
                        {{-- <button type="submit" class="btn btn-outline-dark bg-primary text-white btn-lg mt-3"><i class="bi bi-box-arrow-in-right"></i> Log In</button> --}}
